const required=["NEXT_PUBLIC_APP_URL","NEXT_PUBLIC_ROOT_DOMAIN","NEXT_PUBLIC_SUPABASE_URL","NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY","SUPABASE_SERVICE_ROLE_KEY","SEED_CREDENTIAL_ENCRYPTION_KEY","GITHUB_APP_ID","GITHUB_APP_SLUG","GITHUB_APP_PRIVATE_KEY","GITHUB_APP_CLIENT_ID","GITHUB_APP_CLIENT_SECRET","SUPABASE_OAUTH_CLIENT_ID","SUPABASE_OAUTH_CLIENT_SECRET","VERCEL_CLIENT_ID","VERCEL_CLIENT_SECRET","VERCEL_INTEGRATION_SLUG"];
