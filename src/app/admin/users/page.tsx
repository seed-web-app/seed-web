                  ...
                  <tr key={cust.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          href={`/admin/offers?customer=${cust.id}`}
                          className="inline-flex items-center gap-1.5 rounded-lg bg-suzuki-red px-3 py-1.5 text-xs font-bold text-white transition-colors hover:bg-suzuki-brightred"
                        >
      ...
      {selectedCustomer && (
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-suzuki-carbon border border-white/10 rounded-3xl p-6 sm:p-8 max-w-3xl w-full my-8 shadow-2xl space-y-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {inq.part && (
                          <span className="text-xs font-bold text-white flex items-center gap-1">
                            ...
                            Rs {Number(inq.part.price).toLocaleString()} Ref
                          </span>
                        )}
                      </div>
            ...
            <div className="pt-2 border-t border-white/10 flex flex-wrap justify-end gap-3">
              <Link
                href={`/admin/offers?customer=${selectedCustomer.id}`}
                className="inline-flex items-center gap-2 rounded-xl bg-suzuki-red px-5 py-2.5 text-xs font-bold text-white transition-colors hover:bg-suzuki-brightred"
              >
